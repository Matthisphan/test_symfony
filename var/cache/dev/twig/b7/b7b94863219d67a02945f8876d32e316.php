...
";
    ...
    <form class=\"form\" method=\"post\">
        ...
        if ((isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new RuntimeError('Variable "error" does not exist.', 13, $this->source); })())) {
            ...
            echo "            <script>
                function afficherAlerte() {
                    alert(\"Erreur de connexion : mot de passe ou email invalide.\");
                }
                afficherAlerte();
            </script>
        ";
        ...
        <div class=\"title\">
            <img src=\"";
        // line 29
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("images/logo_login.png"), "html", null, true);
        echo "\" alt=\"login_logo\">
        </div>
        ...
        echo "\" placeholder=\"Email :\" name=\"email\" id=\"inputEmail\" class=\"email input\" autocomplete=\"email\" required autofocus>
        <input type=\"password\" name=\"password\" placeholder=\"Mot de passe :\" id=\"inputPassword\" class=\"email input\" autocomplete=\"current-password\" required>
...
";
    ...
    {
        return array (  162 => 34,  157 => 32,  151 => 29,  147 => 27,  139 => 24,  136 => 23,  134 => 22,  131 => 21,  122 => 14,  120 => 13,  116 => 11,  106 => 10,  94 => 7,  89 => 6,  79 => 5,  60 => 3,  37 => 1,);
    }
...
<div class=\"container\">
    <form class=\"form\" method=\"post\">
        ...
        <div class=\"title\">
            <img src=\"{{ asset('images/logo_login.png') }}\" alt=\"login_logo\">
        </div>

        <input type=\"email\" value=\"{{ last_username }}\" placeholder=\"Email :\" name=\"email\" id=\"inputEmail\" class=\"email input\" autocomplete=\"email\" required autofocus>
        <input type=\"password\" name=\"password\" placeholder=\"Mot de passe :\" id=\"inputPassword\" class=\"email input\" autocomplete=\"current-password\" required>
...
{% endblock %}
", "security/login.html.twig", "C:\\Users\\matth\\Desktop\\test_symfony\\app\\templates\\security\\login.html.twig");
    }
}
